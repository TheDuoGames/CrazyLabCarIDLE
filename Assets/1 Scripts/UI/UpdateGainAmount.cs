...
public class UpdateGainAmount : MonoBehaviour
{
    ...
    public void OnEnable()
    {
        ...
        animTween = transform.parent.DOMoveY(Random.Range(0.5f, 0.8f), 0.5f).SetRelative();
        //animTween2 = transform.parent.DOMoveY(0.2f, 0.1f).SetRelative().SetDelay(0.4f);
        fadeTween = gainTMP.DOFade(0, 0.25f).SetDelay(0.25f).OnComplete(() =>
        {
